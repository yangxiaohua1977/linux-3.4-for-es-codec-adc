...
static struct snd_soc_dai_link es8374_dai_link = {
	.name 		= "ASOC-ES8374",
	.stream_name 	= "es8374 HiFi",
	.cpu_dai_name 	= str_dai_name,			/* nxp_snd_i2s_driver name */
	.platform_name  = DEV_NAME_PCM,			/* nxp_snd_pcm_driver name */
	.codec_dai_name = "ES8374 HiFi",		/* es8316_dai's name */
	.codec_name 	= "es8374.0-0010",		/* es8316_i2c_driver name + '.' + bus + '-' + address(7bit) */
	.ops 			= &es8374_ops,
	.symmetric_rates = 1,
...
static struct snd_soc_card es8374_card = {
	.name 				= "I2S-ES8374",		/* proc/asound/cards */
	.owner 				= THIS_MODULE,
...
MODULE_DESCRIPTION("Sound codec-es8374 driver for the SLSI");
MODULE_LICENSE("GPL");
